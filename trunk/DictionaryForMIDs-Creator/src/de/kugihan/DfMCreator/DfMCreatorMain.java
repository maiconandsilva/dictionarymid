...
public class DfMCreatorMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dictdPanelLayout.setVerticalGroup(
            ...
            .addGroup(dictdPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(DBPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        if (args.length != 0) {
            ...
            if (args[0].equals("-DictdToDictionaryForMIDs")){
            ...
            } else if (args[0].equals("-FontGenerator")){
            ...
            } else if (args[0].equals("-JarCreator")){
