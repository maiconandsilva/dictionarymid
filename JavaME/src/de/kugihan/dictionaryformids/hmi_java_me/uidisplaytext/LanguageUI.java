...
public class LanguageUI {
	...
	public void initValue() throws DictionaryException {
		...
		// create some general purpose entries

		uiDisplayTextItemNewline = getUIDisplayTextItem("Newline", "\n");
		uiDisplayTextItemSpace = getUIDisplayTextItem("Space", " ");
		uiDisplayTextItemNewline = getUIDisplayTextItem("Parameterised", "%1");
	}
	// todo: handle by LanguageUIGeneration
	public UIDisplayTextItem uiDisplayTextItemSpace;  // one single space character
	public UIDisplayTextItem uiDisplayTextItemNewline;  // one single newline character
	public UIDisplayTextItem uiDisplayTextItemParameterised;  // one single parameter (%1)
