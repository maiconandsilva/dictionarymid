...
public class HelpContents extends JPanel
    ...
    private void createNodes(DefaultMutableTreeNode top) {
        ...
        // Dictd Converter
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dictdConverter"),
                path + "gui-DictdToDictionaryForMIDs.html"));
        guiCategory.add(book);

        // Dictionary Generator
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dictionaryGeneration"),
                path + "gui-DictionaryGeneration.html"));
        guiCategory.add(book);

        // Bitmap Font Generator
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("bfg"),
                path + "gui-BitmapFontGenerator.html"));
        guiCategory.add(book);

        // DfM's Jar Creator
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dfmsJarCreator"),
        ...
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("importantChangesNotes"),
                path + "newdictChangeNotes.html"));
        docCategory.add(book);

        // Setting up a new dictionary
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("settingUpDict"),
                path + "newdict.html"));
        docCategory.add(book);

        // Configuring DictionaryForMIDs.properties
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dfm.properties"),
                path + "newdictProperties.html"));
        docCategory.add(book);

        // DictionaryUpdate
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dictUpdt"),
                path + "newdictDictionaryUpdate.html"));
        docCategory.add(book);

        // DictionaryUpdate Advanced features
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dictUpdtAdvanced"),
                path + "newdictDictionaryUpdateAdvanced.html"));
        docCategory.add(book);

        // Normation: Available classes
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("normationAvailableClasses"),
                path + "newdictNormationLang.html"));
        docCategory.add(book);

        // Normation Advanced features
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("normationAdvanced"),
                path + "newdictNormation.html"));
        docCategory.add(book);

        // Multiple source dictionaries
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("multiSourceDicts"),
                path + "newdictMultiple.html"));
        docCategory.add(book);

        // Content declarations
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("contentDeclarations"),
                path + "newdictContent.html"));
        docCategory.add(book);

        // Generation the final Dictionary file
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("genTheDictFiles"),
                path + "newdictDictionaryGeneration.html"));
        docCategory.add(book);

        // Editing DictionaryForMIDs.jar Manually
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("dict.manual.edit"),
        ...
        // Important change notes
        book = new DefaultMutableTreeNode(new BookInfo(I18n.tr("iso639-2-languages.names"),
                path + "ISO_639-2.html"));
        docCategory.add(book);
    }
